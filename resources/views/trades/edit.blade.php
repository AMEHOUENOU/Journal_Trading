<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Modifier trade — {{ $trade->symbol }}</h2>
    </x-slot>
                ...
                <form method="POST" action="{{ route('trades.update', $trade) }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="exit_price" name="exit_price" type="number" step="0.00001" class="mt-1 block w-full" :value="old('exit_price', $trade->exit_price)" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <x-text-input id="stop_loss" name="stop_loss" type="number" step="0.00001" class="mt-1 block w-full" :value="old('stop_loss', $trade->stop_loss)" />
                        </div>
                        <div>
                            <x-input-label for="take_profit" value="Take Profit" />
                            <x-text-input id="take_profit" name="take_profit" type="number" step="0.00001" class="mt-1 block w-full" :value="old('take_profit', $trade->take_profit)" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="pnl" name="pnl" type="number" step="0.01" class="mt-1 block w-full" :value="old('pnl', $trade->pnl)" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="closed_at" name="closed_at" type="datetime-local" class="mt-1 block w-full" :value="old('closed_at', $trade->closed_at?->format('Y-m-d\TH:i'))" />
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('notes', $trade->notes) }}</textarea>
                    </div>
